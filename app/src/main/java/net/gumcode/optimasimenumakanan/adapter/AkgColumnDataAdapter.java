 ...
 */
public class AkgColumnDataAdapter extends TableDataAdapter<Akg> {


    public AkgColumnDataAdapter(Context context, List<Akg> data) {
        super(context, data);
    }

    @Override
    public View getCellView(int rowIndex, int columnIndex, ViewGroup parentView) {
       Akg m = getRowData(rowIndex);
        ...
        switch (columnIndex) {
            case 0:
                ...
                textView.setText(Integer.toString(m.no));
            ...
            case 2:
                ...
                textView2.setText(Float.toString(m.energi));
            ...
            case 3:
                ...
                textView3.setText(Float.toString(m.protein));
            ...
            case 4:
                ...
                textView4.setText(Float.toString(m.karbohidrat));
            ...
            case 5:
                ...
                textView5.setText(Float.toString(m.lemak));
            ...
            case 6:
                ...
                textView6.setText(Integer.toString(m.tipe));
