...
import net.gumcode.optimasimenumakanan.adapter.HasilColumnDataAdapter;
...
public class FragmentHasil extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_hasil, null, false);
        tableView = (SortableTableView) v.findViewById(R.id.table);
        tableView.setHeaderAdapter(new ColumnHeaderAdapter(getActivity(), getResources().getStringArray(R.array.hasil_title)));
        return v;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        tableView.setDataAdapter(new HasilColumnDataAdapter(getActivity(), db.getHasil()));
    }
}
